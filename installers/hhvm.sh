...
# hhvm isn't available for eoan or disco - fails to install because libvpx5 isn't available
hhvm_package=hhvm
...
if ! IsInstalled ${hhvm_package}; then
    ...
    add-apt-repository "deb https://dl.hhvm.com/ubuntu $(lsb_release -cs) main"
    apt-get update
